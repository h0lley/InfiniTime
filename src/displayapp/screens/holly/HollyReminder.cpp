...
HollyReminder::HollyReminder(DisplayApp* app,
  ...
  lv_style_set_bg_color(&gradient_border_style, LV_STATE_DEFAULT, lv_color_hex(0xb6bbd8));
  lv_style_set_bg_grad_color(&gradient_border_style, LV_STATE_DEFAULT, lv_color_hex(0x2c3154));
  ...
  lv_style_set_bg_color(&content_bg_style, LV_STATE_DEFAULT, lv_color_hex(0xACAED5));
  ...
  lv_obj_set_style_local_text_color(time_remaining_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x31385A));

  // Button style
  lv_style_init(&btn_style);
  lv_style_set_bg_color(&btn_style, LV_STATE_DEFAULT, lv_color_hex(0x31385A));
  ...
  lv_obj_set_style_local_bg_color(enabled_switch, LV_SWITCH_PART_BG, LV_STATE_DEFAULT, lv_color_hex(0x31385A));
  lv_obj_set_style_local_bg_color(enabled_switch, LV_SWITCH_PART_INDIC, LV_STATE_DEFAULT, lv_color_hex(0x31385A));
  ...
  lv_obj_set_style_local_bg_color(reminder_dismissal_bg, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x31385A));
...
void HollyReminder::OnButtonEvent(lv_obj_t* object, lv_event_t event) {
  if (event == LV_EVENT_CLICKED) {
    if (object == enabled_switch) {
      if (lv_switch_get_state(enabled_switch)) {
