...
HollyUnused::HollyUnused(DisplayApp* app) : Screen(app) {
  ...
  lv_obj_set_style_local_text_color(title, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x830C5A));
}

HollyUnused::~HollyUnused() {
